...
local tabLayout = make("UIListLayout", { Padding = UDim.new(0, 2), SortOrder = Enum.SortOrder.LayoutOrder }, tabHolder)
...
local function createSection(col, title)
	...
	corner(sec, 3)
	stroke(sec)
	local head = label(title:upper(), UDim2.new(1, -12, 0, 24), UDim2.new(0, 10, 0, 2), sec, Text)
	...
	corner(body, 3)
	local pad = make("UIPadding", { PaddingTop = UDim.new(0, 6), PaddingBottom = UDim.new(0, 6), PaddingLeft = UDim.new(0, 8), PaddingRight = UDim.new(0, 8) }, body)
